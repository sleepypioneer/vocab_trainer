...
<script type="text/javascript" language="javascript">
	let vocabImport1 =<?php echo json_encode($myJSON1); ?> ;
    /*if(vocabImport.length > 0){
        let vocabMine = [...vocabImport];
    }*/
    let vocabImport2 =<?php echo json_encode($myJSON2); ?> ;
    let ImportedVocab = {vocabImport1 : vocabImport1, vocabImport2 : vocabImport2};
